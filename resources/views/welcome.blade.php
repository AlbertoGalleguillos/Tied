  ...
  <div class="container">
    ...
    <div class="col s12 l6">
      <div class="hide-on-med-and-down">
        <br><br>
        <a href="/1" class="waves-effect waves-light btn white black-text right">Opción 2</a>
        <br><br><br><br><br><br><br><br><br><br><br><br>
      </div>
      <div class="card white">
        <br>
          <div class="card-content black-text">
            <span class="card-title center-align"><b>¡ Únete Ahora !</b></span>
            <span class="card-title center-align">Regístrate y comienza a disfrutar los beneficios</span>
            <form action="/register" method="POST">
              ...
              <div class="center-align">
                <button class="btn waves-effect waves-light indigo" type="submit" name="action">Acceder
